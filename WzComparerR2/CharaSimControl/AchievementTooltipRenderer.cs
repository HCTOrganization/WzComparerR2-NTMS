...
namespace WzComparerR2.CharaSimControl
{
    public class AchievementTooltipRenderer : TooltipRender
    {
        ...
        public override Bitmap Render()
        {
            ...
            var timeConvertFormat = "yyyy年 MM月 dd日 HH時 mm分";
            ...
            {
                GearGraphics.DrawString(g, desc, Translator.IsKoreanStringPresent(desc) ? GearGraphics.KMSItemDetailFont2 : GearGraphics.EquipMDMoris9Font, null, 84, 550, ref picHD, 15, defaultColor: GearGraphics.GrayColor2);
            }
            ...
            if (this.Achievement.ShowMissions)
            {
                ...
                foreach (var mission in this.Achievement.Missions)
                {
                    ...
                    TextRenderer.DrawText(g, Compact(g, mission, 235), Translator.IsKoreanStringPresent(mission) ? GearGraphics.KMSItemDetailFont2 : GearGraphics.EquipMDMoris9Font, new Point(32 + dx * col, picH + 1), Color.White, TextFormatFlags.NoPadding);
            ...
            if (!string.IsNullOrEmpty(category))
            {
                ...
                GearGraphics.DrawString(g, $"分類: {category}", GearGraphics.EquipMDMoris9Font, null, 32, 550, ref picH, bg_pattern.Height, defaultColor: GearGraphics.GrayColor2);
            }
            ...
            {
                g.DrawImage(checkIncomplete, 16, picH);
                GearGraphics.DrawString(g, Compact(g, $"前置成就: {string.Join(", ", this.Achievement.PriorIDs.Select(id =>
                {
            ...
            {
                g.DrawImage(checkIncomplete, 16, picH);
                GearGraphics.DrawString(g, "隱藏成就", GearGraphics.EquipMDMoris9Font, null, 32, 550, ref picH, bg_pattern.Height, defaultColor: GearGraphics.GrayColor2);
            }
