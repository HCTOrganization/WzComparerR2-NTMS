...
namespace WzComparerR2
{
    public partial class FrmCustomCSS : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void colorPickers_SelectedColorChanged(object sender, EventArgs e)
        {
            ...
            var contents = new[]
            {
                new {Text = "                常規內容的説明文字               " + Environment.NewLine, Fore = normalTextColor, Back = backgroundColor},
                new {Text = "               已變更內容的説明文字               " + Environment.NewLine, Fore = changedTextColor, Back = changedBackgroundColor},
                new {Text = "               已新增內容的説明文字               " + Environment.NewLine, Fore = addedTextColor, Back = addedBackgroundColor},
                new {Text = "               已刪除內容的説明文字               ", Fore = removedTextColor, Back = removedBackgroundColor}
            };
